...
<body>
    ...
    <main class="container py-5">
        <div class="mb-5">
            ...
            <p class="text-muted">Hola, <?= htmlspecialchars($_SESSION['user']['name'] ?? 'Usuari') ?>. Gestiona els teus viatges.</p>
        </div>
            ...
            <div class="col-md-6 col-lg-4">
                <div class="card h-100 text-center">
                    <div class="card-body">
                        ...
                        <a href="index.php?action=rutes_disponibles" class="btn btn-primary mt-3">Veure Rutes</a>
                    </div>
                </div>
            </div>
            ...
            <div class="col-md-6 col-lg-4">
                <div class="card h-100 text-center">
                    <div class="card-body">
                        ...
                        <a href="index.php?action=afegir_ruta" class="btn btn-primary mt-3">Crear Ruta</a>
                    </div>
                </div>
            </div>
            ...
            <div class="col-md-6 col-lg-4">
                <div class="card h-100 text-center">
                    <div class="card-body">
                        ...
                        <a href="index.php?action=mis_rutes" class="btn btn-primary mt-3">Les Meves Rutes</a>
                    </div>
                </div>
            </div>
            ...
            <div class="col-md-6 col-lg-4">
                <div class="card h-100 text-center">
                    <div class="card-body">
                        ...
                        <a href="index.php?action=converses" class="btn btn-primary mt-3">Converses</a>
                    </div>
                </div>
            </div>
            ...
            <div class="col-md-6 col-lg-4">
                <div class="card h-100 text-center">
                    <div class="card-body">
                        ...
                        <a href="index.php?action=mapa" class="btn btn-primary mt-3">Veure Mapa</a>
                    </div>
                </div>
            </div>
            ...
            <div class="col-md-6 col-lg-4">
                <div class="card h-100 text-center">
                    <div class="card-body">
                        ...
                        <a href="index.php?action=les_meves_reserves" class="btn btn-primary mt-3">Veure Reserves</a>
                    </div>
                </div>
            </div>
            ...
            <div class="col-md-6 col-lg-4">
                <div class="card h-100 text-center">
                    <div class="card-body">
                        ...
                        <a href="index.php?action=perfil" class="btn btn-primary mt-3">Veure perfil</a>
                    </div>
                </div>
            </div>
            ...
            <div class="col-md-6 col-lg-4">
                <div class="card h-100 text-center">
                    <div class="card-body">
                        ...
                        <a href="index.php?action=rankings" class="btn btn-primary mt-3">Veure Ranking</a>
                    </div>
                </div>
            </div>
            ...
            <div class="col-md-6 col-lg-4">
                <div class="card h-100 text-center">
                    <div class="card-body">
                        ...
                        <a href="index.php?action=logout" class="btn btn-outline-secondary mt-3">Sortir</a>
                    </div>
                </div>
            </div>
        </div>
